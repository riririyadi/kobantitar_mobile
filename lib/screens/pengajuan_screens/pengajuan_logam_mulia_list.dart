...
class PengajuanLogamMuliaList extends StatefulWidget {
  const PengajuanLogamMuliaList({Key? key}) : super(key: key);

  @override
  _PengajuanLogamMuliaListState createState() =>
      _PengajuanLogamMuliaListState();
}

class _PengajuanLogamMuliaListState extends State<PengajuanLogamMuliaList> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemCount: controller.pengajuanLogamMulia!.length,
        itemBuilder: (context, index) {
          final pengajuan = controller.pengajuanLogamMulia![index];
          return Padding(
