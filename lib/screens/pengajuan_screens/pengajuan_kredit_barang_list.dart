...
class PengajuanKreditBarangList extends StatefulWidget {
  const PengajuanKreditBarangList({Key? key}) : super(key: key);

  @override
  _PengajuanKreditBarangListState createState() =>
      _PengajuanKreditBarangListState();
}

class _PengajuanKreditBarangListState extends State<PengajuanKreditBarangList> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemCount: controller.pengajuanKreditBarang!.length,
        itemBuilder: (context, index) {
          final pengajuan = controller.pengajuanKreditBarang![index];
          return Padding(
